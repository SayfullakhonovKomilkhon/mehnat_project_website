...
export const sections: MockSection[] = [
  ...
  { id: 5, number: 'V', title: { uz: 'Mehnat haqi', ru: 'Оплата труда', en: 'Wages' } },
  {
    id: 6,
    number: 'VI',
    title: { uz: 'Mehnat intizomi', ru: 'Трудовая дисциплина', en: 'Labor Discipline' },
  },
];
...
export const chapters: MockChapter[] = [
  {
    id: 1,
    number: '1',
    title: { uz: 'Mehnat qonunchiligi', ru: 'Трудовое законодательство', en: 'Labor Legislation' },
    sectionId: 1,
  },
  {
    id: 2,
    number: '2',
    title: { uz: 'Mehnat munosabatlari', ru: 'Трудовые отношения', en: 'Labor Relations' },
    sectionId: 1,
  },
  {
    id: 3,
    number: '3',
    title: { uz: 'Ijtimoiy sheriklik', ru: 'Социальное партнерство', en: 'Social Partnership' },
    sectionId: 1,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: {
      ...
      en: 'Concluding Employment Contract',
    },
    sectionId: 2,
  },
  {
    ...
    title: {
      ...
      en: 'Amending Employment Contract',
    },
    sectionId: 2,
  },
  {
    ...
    number: '7',
    title: {
      uz: 'Ish vaqti normalari',
      ru: 'Нормы рабочего времени',
      en: 'Working Time Standards',
    },
    sectionId: 3,
  },
  {
    id: 8,
    number: '8',
    title: { uz: 'Ish tartibi', ru: 'Режим работы', en: 'Work Schedule' },
    sectionId: 3,
  },
  {
    id: 9,
    number: '9',
    title: { uz: 'Dam olish turlari', ru: 'Виды отдыха', en: 'Types of Rest' },
    sectionId: 4,
  },
  {
    id: 10,
    number: '10',
    title: { uz: "Mehnat ta'tili", ru: 'Трудовой отпуск', en: 'Labor Vacation' },
    sectionId: 4,
  },
];
...
for (let i = 6; i <= 50; i++) {
  ...
  const chapter =
    sectionChapters[Math.floor(Math.random() * sectionChapters.length)] || chapters[0];
